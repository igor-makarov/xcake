  ...
  class ConfigurationGenerator < Generator
    ...
    def create_build_configurations_for(configuration_object)
      ...
      configuration_object.flatten_configurations.each do |configuration|
        ...
        #TODO: BDD This.
        #TODO: Remove need to construct a Node Object.
        #TODO: Move this into its own generator.
        node = Node.new
        ...
        native_configuration_object.base_configuration_reference = file_reference
      end
    end
  end
end
