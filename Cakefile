#Change this with your class prefix for Objective-C files.
class_prefix = "APP"
...
#
application_for :ios, 8.0 do |t|

    #Update these with the details of your app
    t.name = "YourApp"
    t.all_configurations.product_bundle_identifier = "com.yourcompany.yourapp"
